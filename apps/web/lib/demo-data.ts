...
const jwtTeam: Team = {
  ...
  members: [
    { id: "m1", team_id: "demo-team", role: "team_lead", model: "qwen3.5:4b", status: "idle", created_at: BASE_TIME.toISOString() },
    { id: "m2", team_id: "demo-team", role: "builder", model: "qwen2.5-coder:7b", status: "idle", created_at: BASE_TIME.toISOString() },
    { id: "m3", team_id: "demo-team", role: "reviewer", model: "phi4-mini", status: "idle", created_at: BASE_TIME.toISOString() },
    { id: "m4", team_id: "demo-team", role: "tester", model: "qwen3:4b", status: "idle", created_at: BASE_TIME.toISOString() },
  ],
};
...
async def refresh(token: str):
  ...
  return {
    ...
    messages: [
      { id: "demo-msg-1", task_id: "demo-task", step_order: 1, role: "team_lead", model: "qwen3.5:4b", message_type: "plan", content: plan, created_at: addSeconds(1), tokens: 142 },
      { id: "demo-msg-2", task_id: "demo-task", step_order: 2, role: "builder", model: "qwen2.5-coder:7b", message_type: "code", content: code, created_at: addSeconds(4), tokens: 486 },
      { id: "demo-msg-3", task_id: "demo-task", step_order: 3, role: "reviewer", model: "phi4-mini", message_type: "review", content: review, created_at: addSeconds(7), tokens: 89 },
      { id: "demo-msg-4", task_id: "demo-task", step_order: 4, role: "tester", model: "qwen3:4b", message_type: "test", content: test, created_at: addSeconds(9), tokens: 156 },
      { id: "demo-msg-5", task_id: "demo-task", step_order: 5, role: "team_lead", model: "qwen3.5:4b", message_type: "delivery", content: delivery, created_at: addSeconds(11), tokens: 201 },
    ],
...
module.exports = router;` },
  ...
  return {
    ...
    messages: [
      { id: "crud-msg-1", task_id: "demo-task-crud", step_order: 1, role: "team_lead", model: "qwen3.5:4b", message_type: "plan", content: plan, created_at: addSeconds(1), tokens: 98 },
      { id: "crud-msg-2", task_id: "demo-task-crud", step_order: 2, role: "builder", model: "qwen2.5-coder:7b", message_type: "code", content: code, created_at: addSeconds(4), tokens: 523 },
      { id: "crud-msg-3", task_id: "demo-task-crud", step_order: 3, role: "reviewer", model: "phi4-mini", message_type: "review", content: review, created_at: addSeconds(7), tokens: 112 },
      { id: "crud-msg-4", task_id: "demo-task-crud", step_order: 4, role: "tester", model: "qwen3:4b", message_type: "test", content: test, created_at: addSeconds(9), tokens: 178 },
      { id: "crud-msg-5", task_id: "demo-task-crud", step_order: 5, role: "team_lead", model: "qwen3.5:4b", message_type: "delivery", content: delivery, created_at: addSeconds(11), tokens: 167 },
    ],
