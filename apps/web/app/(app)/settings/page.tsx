...
import { Paintbrush, Bell, Key, Server, ChevronRight, ArrowRight, Shield, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-3xl">
      ...
      <div className="space-y-4">
        {/* Providers Card â€” links to /settings/providers */}
      ...
      <div className="text-center text-xs text-muted-foreground py-4">
        AgentForge v0.2.0 â€” Open source multi-agent AI orchestration
      </div>
    </div>
  );
}
