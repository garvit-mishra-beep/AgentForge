...
""")
        ...
        try:
            ...
            print(f"âœ“ Architecture analyzer found {len(arch_result.components)} components")

            # Test the knowledge graph
            kg = RepositoryKnowledgeGraph(str(temp_path))
            result = kg.analyze_repository()
            print(f"âœ“ Knowledge graph analysis completed in {result['duration_seconds']:.2f} seconds")
